...
const Hero = () => {
  return (
    <section className="hero relative h-screen pb-20 md:pb-32 xl:pb-0">
      <div className="mx-[10%] xl:mx-0 xl:ml-[10%] lg:items-center flex flex-col justify-center xl:flex-row">
        <div className="flex flex-col gap-4 max-w-screen-md overflow-hidden text-center xl:text-start">
          <h2 className="text-xl md:text-3xl font-medium mt-20 md:mt-32 xl:mt-40 bg-gradient-to-t from-yellow-500 to-orange-500 bg-clip-text text-transparent">
            Deikairru
          </h2>
          ...
          <motion.div
            ...
            initial="initial"
            animate="animate"
            className={`${anton.className} text-slider xl:block hidden`}
          >
            Fullstack-Developer UI/UX-Designer Content-Creator
          </motion.div>
        </div>
        ...
        <Image
          ...
          width={650}
          height={650}
          className="hidden xl:block mt-32"
        />
      </div>
    </section>
  );
